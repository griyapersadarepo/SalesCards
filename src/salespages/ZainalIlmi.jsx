...
//avatar
import avatar from "../data/images/avatars/sales/compressed/zainalilmi.jpg"
   ...
   <div className={css.canva}>
    ...
    <div className={css.wrapper}>
      ...
      <div className={css.divname}>
        ...
        <p className={css.notelp}>0856 4701 8369</p>
      </div>
...
<img src={tiktokicon} alt="" className={css.tiktokavatar}/>
   ...
   <a href={`https://api.whatsapp.com/send?phone=6285647018369`}
   target="_blank"
   rel="noopener noreferrer">
