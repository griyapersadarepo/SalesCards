...
<img src={tiktokicon} alt="tiktokicon" className={css.tiktokavatar}/>
   ...
   <a href={`https://wa.me/6283842320987?text=Hallo%20Ikasani%20Budiarti`}
   target="_blank"
   rel="noopener noreferrer">
...
export default IkasaniBudiarti;
